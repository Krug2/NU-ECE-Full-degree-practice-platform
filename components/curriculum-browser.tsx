...
export function CurriculumBrowser() {
  ...
  return <>
    ...
    <div className="notice">We&apos;re building one complete course at a time. These are curriculum outlines; lessons and assessments will appear after each course is planned, built, and reviewed.</div>
