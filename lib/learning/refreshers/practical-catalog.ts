import orientationPack from "@/content/learning-packs/f12.json";
import orientationPath from "@/content/refresher-paths/f12.json";
import orientationStudy from "@/content/lessons/f12/m01-l01.json";
import orientationReading from "@/content/lessons/f12/m01-l02.json";
import orientationCalculator from "@/content/lessons/f12/m01-l03.json";
import orientationFiles from "@/content/lessons/f12/m01-l04.json";
...
export const practicalPacks=[engineeringPack,orientationPack].map(p=>packSchema.parse(p));
export const practicalPaths=[engineeringPath,orientationPath].map(p=>practicalPathSchema.parse(p));
export const practicalLessons=[engineeringFrame,engineeringEstimate,engineeringCheck,engineeringRecord,orientationStudy,orientationReading,orientationCalculator,orientationFiles].map(l=>practicalLessonSchema.parse(l));
